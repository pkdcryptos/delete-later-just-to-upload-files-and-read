class AccountVersion < ActiveRecord::Base
  ...
  HISTORY = [Account::STRIKE_ADD, Account::STRIKE_SUB, Account::STRIKE_FEE,  Account::FIX, Account::DEPOSIT, Account::WITHDRAW,  Account::OLDCODE_INTERNAL_DEPOSIT, Account::OLDCODE_INTERNAL_WITHDRAW, Account::OLDCODE_INTERNAL_DEPOSIT, Account::OLDCODE_INTERNAL_WITHDRAW,    Account::PTP_CREATED_TRADE, Account::PTP_DISPUTE_RESOLVED, Account::PTP_REOPENED_TRADE, Account::PTP_CANCELLED_TRADE, Account::PTP_ESCROW_RELEASED, Account::ADMIN_TRANSFER] 
  ...
  REASON_CODES = {
	...
	Account::OLDCODE_INTERNAL_DEPOSIT => 901,
	Account::OLDCODE_INTERNAL_WITHDRAW => 902,	
	Account::OLDCODE_PTP_DEPOSIT => 903,
	Account::OLDCODE_PTP_WITHDRAW => 904,	
	

	
	Account::PTP_CREATED_TRADE => 2001,
	Account::PTP_DISPUTE_RESOLVED => 2002, 
	Account::PTP_REOPENED_TRADE => 2003,
	Account::PTP_CANCELLED_TRADE => 2004,
    Account::PTP_ESCROW_RELEASED => 2005,
	Account::ADMIN_TRANSFER => 3001
  ...
  def self.optimistically_lock_account_and_create!(balance, locked, attrs)
    ...
    attrs[:reason1]     = attrs[:reason1]
    attrs[:reason2]     = attrs[:reason2]
    attrs[:reason3]     = attrs[:reason3]
