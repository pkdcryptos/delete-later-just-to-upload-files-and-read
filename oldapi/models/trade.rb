class Trade < ActiveRecord::Base
  ...
  def dbg_record
     #Rails.logger.info "DBG: Trade record: id: #{self.id}, price: #{price}, volume: #{volume}, ask_id: #{ask_id}, bid_id: #{bid_id}, ask_member_id: #{ask_member_id}, bid_member_id: #{bid_member_id}, funds: #{funds}"
  end
